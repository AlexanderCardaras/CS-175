...
flags = Namespace(
    train_file='parsed_data.txt',
    seq_size=32,
    batch_size=64,
    embedding_size=64,
    lstm_size=64,
    gradients_norm=5,
    initial_words=['The', 'state'],
    predict_top_k=5,
        ...
        for x, y in batches:
            ...
            if iteration % 1000 == 0:
                ...
                torch.save(net.state_dict(),
                           'checkpoint_model/model-{}.pth'.format(iteration))
    
    torch.save(net.state_dict(), 'checkpoint_model/model-{}.pth'.format(iteration))
